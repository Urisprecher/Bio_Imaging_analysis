...
def main(main_folder, main_folder_path):
    print(Fore.GREEN + "Starting Timepoint IF analysis for each plate in in folder in your main directory:)")
    ...
    process_plate_data_on_folders(main_folder_path, list1, list2, list3)
    print("Completed per plate Timepoint IF analysis, good luck with statistics:)")
