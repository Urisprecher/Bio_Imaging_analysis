                        ...
                        try:
                            ...
                            for col in bar_df:
                                if col in important_features:
                                    ...
                                    bp.update_traces(quartilemethod="inclusive")
                                    bp.update_layout(
                                        font_family="Arial",
                                        font_color="Black",
                                        font_size=20,
...
def gather_user_lists():
    ...
    print("usual important columns: spots_chanel_3 - Corrected Spot Intensity - Mean per Well, spots_chanel_3 - Intensity_Spot chanel_3_final Mean - Mean per Well, selected_cells - Cell Area, selected_cells - chanel_3 Gabor Max 2 px w2 - Mean per Well, selected_cells - chanel_3_Intensity Mean - Mean per Well, selected_cells - chanel_1 Area, total_ir_chanel_3_area_normalized, total_ir_chanel_3_intensity_normalized")
...
def main(main_folder, main_folder_path):
    ...
    print(Fore.GREEN + "STEP 3 - running analysis on each plate at a time...")
    process_plate_data_on_folders(main_folder_path, list1, list2, list3)
    print("Completed per plate IF analysis, good luck with statistics:)")
