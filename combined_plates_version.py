...
def process_data_combine(folder_path):
    try:
        ...
        output_folder = os.path.join(main_folder, "IF_result_combined")
        os.makedirs(output_folder, exist_ok=True)
        result_combine_dir = os.path.join(main_folder, "IF_result_combined/combined_csv_file")
        ...
        print(f"review the files saved in {main_folder}/IF_result_combined/combined_csv_file.")
    except Exception as e:
...
def main(main_folder, main_folder_path, final_folder_path):
    print(Fore.GREEN + "Starting IF analysis for combined file of all plates in folder in your main directory:)")
...
if __name__ == "__main__":
    ...
    final_folder_path = input("Enter: the main folder name/IF_result_combined ")
